...
- python visualizer_with_classifier.py -f test.dat -m pose_classifier.pt (Runs AI model with visualizer on some .dat input for testing)
- python evaluate_test_dataset.py --data combined_test.npz --model pose_classifier.pt --out_dir eval_results (Takes in batch output of testset folder)
